...
function track(target, type, key) {
  if (!shouldTrack$1 || activeEffect === void 0) {
    return;
  }
...
function triggerRef(ref2) {
  trigger$1(toRaw(ref2), "set", "value", void 0);
}
function unref(ref2) {
...
class CustomRefImpl {
  constructor(factory) {
    this.__v_isRef = true;
    const {get: get2, set: set2} = factory(() => track(this, "get", "value"), () => trigger$1(this, "set", "value"));
    this._get = get2;
    this._set = set2;
  }
  get value() {
...
function patchSuspense(n1, n2, container, anchor, parentComponent, isSVG, {p: patch, um: unmount, o: {createElement: createElement2}}) {
...
var headObjToTags = (obj) => {
  ...
  for (const key of Object.keys(obj)) {
    ...
    if (key === "title") {
      ...
      tags.push({tag: key, props: __assign({key: "default"}, obj[key])});
...
var vnodesToHeadObj = (nodes) => {
  ...
  for (const node of nodes) {
    ...
    if (typeof type !== "string" || !(type in obj))
      continue;
    const props = __assign(__assign({}, node.props), {
...
function setupServerAPI(globalProperties) {
  ...
  globalProperties.$api = new Proxy($api, {get: getFetchWrapper});
}
...
export {Fragment as F, Suspense as S, useRoute as a, createVNode as b, createBlock as c, resolveDynamicComponent as d, createTextVNode as e, createRouter as f, createWebHistory as g, createSSRApp as h, createHead as i, hydrate_1 as j, reactive as k, popScopeId as l, withScopeId as m, createStaticVNode as n, openBlock as o, pushScopeId as p, require$$0 as q, resolveComponent as r, renderList as s, unref as t, useHead as u, toDisplayString as v, withCtx as w};
