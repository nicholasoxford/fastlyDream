...
var createElement = /* @__PURE__ */ __name((tag, attrs, document) => {
...
var htmlEscape = /* @__PURE__ */ __name((str) => str.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "htmlEscape");
var stringifyAttrs = /* @__PURE__ */ __name((attributes) => {
...
var getTagKey = /* @__PURE__ */ __name((props) => {
  if (props.key !== void 0) {
...
var injectHead = /* @__PURE__ */ __name(() => {
...
var headObjToTags = /* @__PURE__ */ __name((obj) => {
  const tags = [];
...
var setAttrs = /* @__PURE__ */ __name((el, attrs) => {
...
var insertTags = /* @__PURE__ */ __name((tags, document = window.document) => {
...
var createHead = /* @__PURE__ */ __name(() => {
  let allHeadObjs = [];
  const head = {
    install(app) {
...
var useHead = /* @__PURE__ */ __name((obj) => {
...
var tagToString = /* @__PURE__ */ __name((tag) => {
...
var renderHeadToString = /* @__PURE__ */ __name((head) => {
  const tags = [];
  let titleTag = "";
  let htmlAttrs = {};
  let bodyAttrs = {};
...
var vnodesToHeadObj = /* @__PURE__ */ __name((nodes) => {
  const obj = {
    title: void 0,
    htmlAttrs: void 0,
    bodyAttrs: void 0,
...
var Head = (0, import_vue.defineComponent)({
  name: "Head",
  setup(_, {slots}) {
    const head = injectHead();
    let obj;
